...
<?= Html::submitButton(AdminHtml::awesome('file-excel-o') . ' ส่งออกไฟล์ XLS', ['class' => 'btn btn-success', 'name' => 'mode', 'value' => 'test', 'style'=>['display' => 'none']]); ?>
<?php ActiveForm::end(); ?>
<div class="row">
    <div class="col-sm-8">
        <?=
