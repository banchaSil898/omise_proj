...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="well well-sm">
            <h5 class="text-bold">สินค้าที่ต้องการแสดง</h5>
            <?php
            $form = ActiveForm::begin([
                        'type' => 'horizontal',
                        'method' => 'get',
                        'action' => ['bundle-product', 'id' => $model->id],
                        'options' => [
                            'data-pjax' => 1,
                        ],
            ]);
    ...
    <div class="col-sm-6">
        ...
        ?>
        <div class="well well-sm">
            <h5 class="text-bold">เลือกสินค้า</h5>
            <?php
            $form = ActiveForm::begin([
                        'type' => 'horizontal',
                        'method' => 'get',
        ...
        ?>
        <?=
        Html::submitButton(Html::icon('chevron-left') . ' นำเข้า (<span id="product-select-count">0</span>)', [
            'id' => 'btn-import',
            'class' => 'btn btn-default',
            'disabled' => true,
        ]);
