...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="well well-sm">
            ...
            $form = ActiveForm::begin([
                        'type' => 'horizontal',
                        'method' => 'get',
                        'action' => ['update-item', 'id' => $model->id],
                        'options' => [
                            'data-pjax' => 1,
                        ],
            ]);
        ...
        $form = ActiveForm::begin([
                    ...
                    'method' => 'post',
                    'action' => ['item-remove', 'id' => $model->id],
                    'options' => [
                        'data-pjax' => 0,
                    ],
        ]);
    ...
    <div class="col-sm-6">
        ...
        ?>
        <div class="well well-sm">
            <h5 class="text-bold">เลือก<?=$title;?>ในโปรโมชั่น</h5>
            <?php
            $form = ActiveForm::begin([
                        'type' => 'horizontal',
                        'method' => 'get',
        ...
        $form = ActiveForm::begin([
                    ...
                    'method' => 'post',
                    'action' => ['item-import', 'id' => $model->id],
                    'options' => [
                        'data-pjax' => 0,
                    ],
        ]);
        ?>
        <?=
        Html::submitButton(Html::icon('chevron-left') . ' นำเข้า' . $title . ' (<span id="product-select-count">0</span>)', [
            'id' => 'btn-import',
            'class' => 'btn btn-default',
            'disabled' => true,
        ]);
