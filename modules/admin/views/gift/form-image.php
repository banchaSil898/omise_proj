    ...
    'columns' => [
        ...
        [
            ...
            'value' => function($model) {
                return Html::a(Html::img($model->thumbUrl ? $model->thumbUrl : Html::placeholder(48, 65), ['width' => 48]), ['preview-image', 'gift_id' => $model->gift_id, 'image_id' => $model->image_id], ['data-pjax' => '0', 'data-modal' => 1, 'data-modal-size' => 'lg']);
            },
            'format' => 'raw',
            'headerOptions' => [
                'width' => 128,
