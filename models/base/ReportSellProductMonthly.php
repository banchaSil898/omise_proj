...
/**
 * This is the model class for table "report_sell_product_monthly".
 *
 ...
 */
class ReportSellProductMonthly extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'report_sell_product_monthly';
    }
