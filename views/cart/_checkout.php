...
<?php if (isset($survey2019) && $survey2019->enabled): ?>
    ...
    Modal::begin([
        ...
        'header' => Html::tag('h3', 'แบบสำรวจข้อมูล'),
    ]);
    ?>
    <?php
    $form = ActiveForm::begin([
    ...
    <div class="form-group">
        <div class="col-md-9 col-md-offset-3">
            <p>ข้าพเจ้ายินดีให้ความร่วมมือในการสำรวจข้อมูล</p>
        </div>
    </div>
    <hr/>
    <?= Html::submitButton('ส่งข้อมูล', ['class' => 'btn btn-success btn-lg pull-right']); ?>
    <?= Html::button('ข้าม', ['class' => 'btn btn-default btn-lg', 'data-dismiss' => 'modal']); ?>
    <?php ActiveForm::end(); ?>
    <?php Modal::end(); ?>
    <?php JSRegister::begin(); ?>
    <script>
